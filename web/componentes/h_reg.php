      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          if (!isset($_SESSION['usuario'])) {
              print
               "<div class='d-flex'><a class='btn ms-auto nombres nombres1 cambio' href='login.php'>Iniciar sesión</a></div>
               <div class='d-flex'><a class='btn ms-auto nombres nombres1 cambio' href='registro.php'>Registrate</a></div>";
          } 
